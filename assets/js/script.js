(function ($) {
    ...
    function initCustomScripts() {
        console.log('🚀 initCustomScripts called');
        $('.select').niceSelect();
       ...
       ================================== */
        ...
        -------------------------------------------*/
        function preloader() {
            console.log('🚀 preloader function called',$('.preloader').length); 
            if ($('.preloader').length) {
      ...
      -------------------------------------------*/
        ...
        if ($(".header-search-form-wrapper").length) {
            ...
            searchToggleBtn.on("click", function (e) {
                ...
                searchToggleBtnIcon.toggleClass("fi ti-music fi ti-close");
                e.stopPropagation();
            });
       ...
       -------------------------------------------*/
        ...
        -------------------------------------------*/
        if ($("#clock").length) {
            $('#clock').countdown('2025-12-13 16:00:00', function (event) {
        ...
        -------------------------------------------*/
        if ($("#clock2").length) {
            $('#clock2').countdown('2025-12-13 16:00:00', function (event) {
                var $this = $(this).html(event.strftime(''
                    + '<div class="box"><div><div class="time">%D</div> <span>Days</span> </div></div>'
                    + '<div class="box"><div><div class="time">%H</div> <span>Hours</span> </div></div>'
                    + '<div class="box"><div><div class="time">%M</div> <span>Mins</span> </div></div>'
        ...
        -------------------------------------------*/
        if ($("#clock3").length) {
            $('#clock3').countdown('2025-12-13 16:00:00', function (event) {
                var $this = $(this).html(event.strftime(''
        ...
        if ($("#contact-form-main").length) {
            $("#contact-form-main").validate({
                ...
                messages: {
                    ...
                    guest: "Debe seleccionar una cantidad de invitados",
